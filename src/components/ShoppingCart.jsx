  ...
  render() {
    return (
      ...
      {/* The following SVG came from https://fontawesome.com/ using their free license. */}
        ...
        style={this.props.cartStyle} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="shopping-cart" className="svg-inline--fa fa-shopping-cart fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
